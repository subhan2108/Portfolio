...
export const Component = ({ testimonials }: ComponentProps) => {
    ...
    return (
        <div className="w-full text-black h-[500px] md:h-[600px] flex justify-center items-center py-10 scale-[0.85] sm:scale-95 md:scale-100 transition-transform duration-500 overflow-hidden relative">
            <div className="flex justify-center items-center w-full max-w-full mx-auto container">
                <HTMLFlipBook
                    ref={book}
                    ...
                    {/* --- Cover --- */}
                    <div className="relative bg-[#0D0D0D] border border-white/10 rounded-lg py-8 px-4 sm:px-8 text-white flex flex-col items-center justify-center shadow-2xl cursor-grab h-full w-full">
